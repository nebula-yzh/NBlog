...
public class CommentController {
     ...
     * 成zset存储对象
     *
     * @param pageCommentList 评论列表
     * @return
     */
    private List<ZSetOperations.TypedTuple<String>> transferToZSetTypedTupleList(List<PageComment> pageCommentList) {
